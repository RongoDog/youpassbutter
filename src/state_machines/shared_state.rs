...
pub struct SharedState {
  ...
  pub hardware_pointers: HardwareInterfacePointers,
}
...
impl SharedState {
  pub fn new(is_simulation: bool, current_position: mint::Point3<f32>) -> Self {
    let hardware_pointers = HardwareInterfacePointers::new();
    let managed_state_mutex: Arc<Mutex<ManagedState>> = 
      Arc::<Mutex<ManagedState>>::new(Mutex::<ManagedState>::new(ManagedState {
      speed_x: 0.0,
      speed_y: 0.0,
      speed_z: 0.0,
      x: 0.0,
